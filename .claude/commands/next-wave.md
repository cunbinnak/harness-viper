...
Copy vào `archive/wave-N/` — **chép hết, không chọn lọc** ("chép doc nào" là phán đoán sẽ mục): `STATE.md` (gate+logs) ·
`tracking/wave-N/test-cases.md` · bản `docs/` in-scope wave (FEAT/arch). Từ đây **BẤT BIẾN — là hợp đồng**.
